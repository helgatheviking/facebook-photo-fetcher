...
//Non-database vars
global $fpf_name, $fpf_version, $fpf_identifier, $fpf_shortcode_tag, $fpf_homepage;
...
add_shortcode( 'fbgallery', 'fpf_display_gallery' );
function fpf_display_gallery( $args ){
    global $post;
    $content = get_post_meta( $post->ID, '_fpf_album_html', true );
    return $content;
}
